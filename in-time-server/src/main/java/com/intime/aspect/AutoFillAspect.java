package com.intime.aspect;

import com.intime.annotation.AutoFill;
import com.intime.constan.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.intime.mapper.*.*(..)) && @annotation(com.intime.annotation.AutoFill)")
